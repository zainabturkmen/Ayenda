            ...
            return (
              ...
              >
                <NavLink
                  to={url}
                  className={({ isActive }) =>
                    `inline-flex items-center text-gray-900 text-lg font-light transition-colors duration-200 ease-in-out ${
                      isActive ? "gradient-text" : "hover:gradient-text"
                    }`
                  }
                >
                  {text}
                  ...
                  <div className="absolute top-full left-0 bg-white shadow-lg rounded-md z-10 flex flex-col gap-2 p-3 w-56 text-center">
                    {sublinks.map((sublink) => (
                      <NavLink
                        ...
                        to={sublink.url}
                        className={({ isActive }) =>
                          `text-gray-900 text-base py-2 transition-colors duration-200 ease-in-out ${
                            isActive ? "gradient-text" : "hover:gradient-text"
                          }`
                        }
          ...
          return (
            <li key={id}>
              <NavLink
                to={url}
                className={({ isActive }) =>
                  `text-gray-900 text-lg font-light transition-colors duration-200 ease-in-out ${
                    isActive
                      ? "gradient-text gradient-border-b-4"
                      : "hover:gradient-text"
                  }`
                }
              >
